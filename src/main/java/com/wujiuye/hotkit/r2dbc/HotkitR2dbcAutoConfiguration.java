...
import com.wujiuye.hotkit.r2dbc.mode.cluster.ClusterModeConfig;
import com.wujiuye.hotkit.r2dbc.mode.ms.MasterSlaveModeConfig;
import com.wujiuye.hotkit.r2dbc.mode.BaseModeConnectionFactory;
import com.wujiuye.hotkit.r2dbc.mode.cluster.ClusterConnectionFactory;
import com.wujiuye.hotkit.r2dbc.mode.ms.MasterSlaveConnectionFactory;
...
@Configuration
public class HotkitR2dbcAutoConfiguration extends AbstractR2dbcConfiguration {
    ...
    public ConnectionFactory connectionFactory() {
        return new HotkitR2dbcRoutingConnectionFactory(createBaseModeConnectionFactory());
    }
